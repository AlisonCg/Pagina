...
<body>
	<div class="main-container">
		...
		<section class="op">
			<h1 class="op1"> CONTACTO </h1>
		</section>
		<section>
			<article class="A1">
				<h2><b><big>CONTÁCTANOS
				<BR><BR></big></b></h2>
				<h3 class="op4">
					ATENCIÓN AL CLIENTE NAKÚ
					<BR><BR>
					Teléfonos:
					<BR><BR>
					México:   55 5382 9901
					...
					Correo Electrónico
					<BR><BR>
					atencionalcliente@naku_cdmx.com.mx
					<BR><BR>
			...
			<aside>
				<img class="op3" src="multimedia/acl.gif" alt="Funny image">
			</aside>
		</section>
		<footer>
			<table>
